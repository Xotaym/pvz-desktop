...
const WAVE_CONFIGS = [
  { zombies: [
    ...
    { type: 'zombie_copy', row: 1, delay: 10000 },
  ]},
  { zombies: [
    { type: 'zombie',      row: 0, delay: 0 },
    { type: 'zombie_copy', row: 3, delay: 3000 },
    { type: 'zombie',      row: 1, delay: 6000 },
    { type: 'zombie_copy', row: 4, delay: 9000 },
  ]},
  { zombies: [
    { type: 'zombie',      row: 0, delay: 0 },
    { type: 'hdd_zombie',  row: 2, delay: 2000 },
    { type: 'zombie_copy', row: 4, delay: 4000 },
  ...
  { zombies: [
    ...
    { type: 'zombie_copy',    row: 0, delay: 7500 },
