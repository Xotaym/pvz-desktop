...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.2.7-2ecc71?style=flat-square" />
...
Можно создавать свои волны зомби! Положите JSON-файл в папку `custom_waves/` и запустите через панель разработчика:
